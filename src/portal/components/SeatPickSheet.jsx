    ...
    >
      ...
      >
        ...
        >
          {remaining > 0 ? (
            <>
              <b style={{ color: TOKENS.brand.gold }}>{remaining}</b> to place
            </>
          ) : (
        ...
        >
          ...
          >
            ...
            >
              {movie.title}
              {movie.year ? (
                <span style={{ color: TOKENS.text.tertiary, fontWeight: 500 }}> ({movie.year})</span>
              ) : null}
            </div>
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              ...
              {movie.runtime && (
                <span style={{ fontSize: 10, color: TOKENS.text.tertiary, fontVariantNumeric: 'tabular-nums' }}>
      ...
      >
        ...
        >
          {adaptedTheater ? (
            ...
            <div style={{ padding: 24, color: TOKENS.text.tertiary, textAlign: 'center' }}>
              No theater selected
            </div>
          )}
        </div>
      ...
      >
        ...
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5 }}>
          <span style={{ width: 9, height: 9, borderRadius: 2, background: TOKENS.brand.gold }} />
          Yours
        </span>
      </div>
