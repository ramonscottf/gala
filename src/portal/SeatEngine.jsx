...
export const SeatMap = ({
  ...
  // The seat map is the single dark-surface exception in the iOS-native
  // theme — its cinema-dark interior is hardcoded here, not driven by
  // any system theme branch.
  const dark = true;
...
export const SeatLegend = ({
  ...
  // The legend always renders inside the dark seat-map sheet, so use
  // light-on-dark text and a faint translucent "taken" swatch.
  const textColor = 'rgba(255,255,255,0.7)';
  const takenColor = 'rgba(255,255,255,0.16)';
  return (
    <div
      style={{
        display: 'flex',
